...
std::string CJsonObject::operator()(const std::string& strKey) const
{
    ...
    else if (pJsonStruct->type == cJSON_Int)
    {
        ...
        if (pJsonStruct->sign == -1)
        {
            ...
            {
                sprintf_s(szNumber, sizeof(szNumber), "%d", (int32)pJsonStruct->valueint);
            }
            else
            {
                sprintf_s(szNumber, sizeof(szNumber), "%lld", (int64)pJsonStruct->valueint);
            }
        }
        else
        {
            ...
            {
                sprintf_s(szNumber, sizeof(szNumber), "%u", (uint32)pJsonStruct->valueint);
            }
            else
            {
                sprintf_s(szNumber, sizeof(szNumber), "%llu", pJsonStruct->valueint);
            }
        }
    ...
    else if (pJsonStruct->type == cJSON_Double)
    {
        ...
        {
            sprintf_s(szNumber, sizeof(szNumber), "%e", pJsonStruct->valuedouble);
        }
        else
        {
            sprintf_s(szNumber, sizeof(szNumber), "%f", pJsonStruct->valuedouble);
        }
    }
